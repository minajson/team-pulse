 ...
 * works, but costs an extra render pass on every mount and trips React's
 * cascading-render rule. `useSyncExternalStore` is the primitive built for
 * exactly this: it renders the server snapshot during SSR and the real value
